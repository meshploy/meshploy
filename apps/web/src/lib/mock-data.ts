...
export const mockNodes: Node[] = [
  {
    ...
    memoryGB: 8,
    diskGB: 80,
    lastSeenAt: new Date(Date.now() - 45 * 1000),
  ...
  },
  {
    ...
    name: "ap-southeast-worker-01",
    tailscaleIP: "100.64.0.5",
    status: "offline",
    k3sRole: "agent",
    k3sVersion: "v1.27.8+k3s1",
    os: "CentOS Stream 9",
    cpuCores: 4,
    memoryGB: 8,
    diskGB: 80,
...
export const mockServices: Service[] = [
  ...
  },
  {
    ...
    type: "application",
    status: "running",
    image: "ghcr.io/acme/ingestion:v1.0.0",
    replicas: 3,
    nodeId: mockNodes[3].id,
    createdAt: new Date("2025-01-08"),
  },
  {
    id: "svc_06",
  ...
  },
  {
    ...
    type: "application",
    status: "stopped",
    image: "ghcr.io/acme/transform:v0.9.2",
    replicas: 2,
