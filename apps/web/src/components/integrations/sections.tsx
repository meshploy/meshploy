...
/**
 * The integration categories, one route each under /integrations. Each export
 * is a whole tab, read by its route file.
 */
...
function useOrgToken() {
  return { token: useAuthStore((s) => s.token)!, orgId: useOrgStore((s) => s.currentOrg?.id)! }
}

export function RegistriesTab() {
  return <RegistrySection {...useOrgToken()} />
}

export function StorageTab() {
  return <StorageSection {...useOrgToken()} />
}

export function NotificationsTab() {
  return <NotificationsSection {...useOrgToken()} />
}

export function EmailProviderTab() {
  return <EmailProviderSection {...useOrgToken()} />
}

// ─── Git section ──────────────────────────────────────────────────────────────

export function GitSourcesTab() {
  const { token, orgId } = useOrgToken()
